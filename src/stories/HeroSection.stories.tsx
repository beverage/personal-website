...
export const Portfolio: Story = {
  args: {
    title: 'Alex Beverage',
    description: 'Full-stack developer, designer, and digital creator building the future one project at a time.',
...
export const Product: Story = {
  args: {
    ...
    description: 'Transform the way you work with our cutting-edge productivity platform.',

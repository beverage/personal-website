...
export class CenterClusterStar3D {
  ...
  reset() {
    ...
    const effectiveSemiMajorAxis = this.clusterSemiMajorAxis * scaleFactor * this.concentration;
    const effectiveSemiMinorAxis = this.clusterSemiMinorAxis * scaleFactor * this.concentration;
